...
<div class="login" id="theme-my-login<?php $template->the_instance(); ?>">
	...
	<form name="resetpasswordform" id="resetpasswordform<?php $template->the_instance(); ?>" action="<?php $template->the_action_url( 'resetpass' ); ?>" method="post">
		<div class="inputPair">
			...
			<input autocomplete="off" name="pass1" id="pass1<?php $template->the_instance(); ?>" class="input input-text" size="20" value="" type="password" />
		</div>
		<div class="inputPair">
			<label for="pass2<?php $template->the_instance(); ?>"><?php _e( 'Confirm Password:', $theme_my_login->textdomain );?></label>
			<input autocomplete="off" name="pass2" id="pass2<?php $template->the_instance(); ?>" class="input input-text" size="20" value="" type="password" />
		</div>
<?php
